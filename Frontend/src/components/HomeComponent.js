    ...
    return (
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>range of content, including blockbuster hits, classic films, indie gems, and popular TV series.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>navigate through a list of genres such as <br></br>Action, Comedy, Drama, Horror, Romance, Sci-Fi, Documentary, and more</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
          showcases movie popularity and highlights what is currently favored by the community.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
    </Carousel>
